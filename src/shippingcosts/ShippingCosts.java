...
public class ShippingCosts {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Final Project: Shipping Costs by JC Boyd\n");
        do {
            System.out.print("Enter a shipping weight: ");
            weight = Double.parseDouble(stdIn.nextLine());
            System.out.print("Enter a shipping distance: ");
            distance = Double.parseDouble(stdIn.nextLine());
        } while (weight <= 0 | distance <= 0);
        
        System.out.printf("%s%.2f%s%.2f%s%.2f\n",
                "The cost for shipping ", weight, " pounds ", 
                distance, " miles is: $", 
                getCost(getWeightFactor(weight), getDistanceFactor(distance)));
    } //end main
